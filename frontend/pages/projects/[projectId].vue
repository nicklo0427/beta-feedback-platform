  ...
  <main class="app-shell">
    <section class="resource-shell">
      <header class="resource-shell__header">
        ...
        >
          <span class="resource-shell__meta-chip">相關活動 {{ campaigns.length }}</span>
          <span class="resource-shell__meta-chip">
            {{ project.owner_account_id ? `擁有者 ${project.owner_account_id}` : '尚未建立擁有者資訊' }}
          </span>
        </div>
      </header>
      ...
      >
        <div class="detail-layout__main">
          <section class="resource-section" data-testid="project-campaigns-section">
            <span class="resource-section__eyebrow">Project Workspace</span>
        ...
        <aside class="detail-layout__rail">
          <section class="resource-section" data-testid="project-detail-panel">
            <span class="resource-section__eyebrow">Project Summary</span>
